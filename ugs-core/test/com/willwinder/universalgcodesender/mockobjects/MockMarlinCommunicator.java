...
import com.willwinder.universalgcodesender.MarlinCommunicator;
 ...
 * @author wwinder
 */
public class MockMarlinCommunicator extends MarlinCommunicator {
    // Inputs.
    ...
    public MockMarlinCommunicator() {
        //super();
		this.connection = new MockConnection(null, baos);
